...
constexpr auto sorted(std::array<hand, size> range) {
	std::ranges::sort(range, [](hand a, hand b) static {
		return std::tie(a.kind, a.hand) < std::tie(b.kind, b.hand);
	});
	return range;
}
